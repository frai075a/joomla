	...
	<div class="clearfix">
		<div class="js-stools-container-bar">
			<label for="filter_search" class="element-invisible"
				aria-invalid="false"><?php echo Text::_('COM_QTTR_RECHNER_SEARCH_FILTER_SUBMIT'); ?></label>
				<div class="input-group mb-3">
					<?php echo $search_filter->input; ?>
					<div class="input-group-append">
						<button class="btn btn-outline-success hasTooltip" title=""
					data-original-title="<?php echo Text::_('COM_QTTR_RECHNER_SEARCH_FILTER_SUBMIT'); ?>">
