...
namespace Ttc\Component\Ferienverwaltung\Site\Controller;
...
class DisplayController extends \Joomla\CMS\MVC\Controller\BaseController
{
	...
	public function display($cachable = false, $urlparams = false)
	{
		...
		$view = $this->input->getCmd('view', 'ferienverwaltungsdialog');
		$view = $view == "featured" ? 'ferienverwaltungsdialog' : $view;
